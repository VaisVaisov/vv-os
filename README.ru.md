...
3. **Попробуйте или установите**:
   ...
   - **Готовы установить?**: Запустите "Install VV OS" с рабочего стола или выполните:
     ```bash
...
1. **Вход**: SDDM автовход сразу приведёт вас в Hyprland
2. **Подождите 1-2 минуты**: Первый запуск генерирует Material 3 темы из обоев

### Быстрая настройка

- **Сменить обои**: Нажмите кнопку с совой (правый верхний угол) → Control Center → Wallpaper
...
### v2.0.0: Кастомный GUI установщик
- Красивый графический установщик с киберпанк темой (самописное решение, не Calamares)
...
- **VV OS для Android**: Превращаем старые телефоны в ретро-игровые консоли (долгосрочная перспектива)
